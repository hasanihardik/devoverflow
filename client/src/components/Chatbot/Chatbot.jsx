...
const Chatbot = ({ setIsOpen, isVerified, setIsVerified }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${process.env.API_BASE_URL}/chatbot/`, {
        method: 'POST',
        headers: {
  ...
  const handleEmailSubmit = async (e) => {
    e.preventDefault()
    const response = await fetch(`${process.env.API_BASE_URL}/otp/sendOTP`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  const handleOTPSubmit = async (e) => {
    e.preventDefault()
    const response = await fetch(`${process.env.API_BASE_URL}/otp/verifyOTP`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
